...
namespace Meshwork.Client.GtkClient.Widgets
{
	...
	public class ZoomableNetworkMap : ZoomableCairoArea
	{
		...
		public ZoomableNetworkMap ()
		{
			...
			Runtime.Core.NetworkAdded += (NetworkEventHandler)DispatchService.GuiDispatch(new NetworkEventHandler(AddNetwork));
		    Runtime.Core.NetworkRemoved += (NetworkEventHandler)DispatchService.GuiDispatch(new NetworkEventHandler(DeleteNetwork));
